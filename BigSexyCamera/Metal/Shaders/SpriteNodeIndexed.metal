...
#define SpriteNodeIndexedYCBCRFragmentIndexTextureY 0
#define SpriteNodeIndexedYCBCRFragmentIndexTextureCBCR 1
#define SpriteNodeIndexedYCBCRFragmentIndexSampler 2
#define SpriteNodeIndexedYCBCRFragmentIndexUniforms 3
...
fragment float4 sprite_node_indexed_3d_ycbcr_fragment(SpriteNodeIndexedColorInOut in [[stage_in]],
                                                constant SpriteNodeIndexedFragmentUniforms & uniforms [[buffer(SpriteNodeIndexedYCBCRFragmentIndexUniforms)]],
                                                      texture2d<half> colorMapY [[ texture(SpriteNodeIndexedYCBCRFragmentIndexTextureY) ]],
                                                      texture2d<half> colorMapCBCR [[ texture(SpriteNodeIndexedYCBCRFragmentIndexTextureCBCR) ]],
                                                sampler colorSampler [[ sampler(SpriteNodeIndexedYCBCRFragmentIndexSampler) ]]) {
...
fragment float4 sprite_node_colored_indexed_3d_ycbcr_fragment(SpriteNodeColoredIndexedColorInOut in [[stage_in]],
                                                constant SpriteNodeIndexedFragmentUniforms & uniforms [[buffer(SpriteNodeIndexedYCBCRFragmentIndexUniforms)]],
                                                              texture2d<half> colorMapY [[ texture(SpriteNodeIndexedYCBCRFragmentIndexTextureY) ]],
                                                              texture2d<half> colorMapCBCR [[ texture(SpriteNodeIndexedYCBCRFragmentIndexTextureCBCR) ]],
                                                              sampler colorSampler [[ sampler(SpriteNodeIndexedYCBCRFragmentIndexSampler) ]]) {
